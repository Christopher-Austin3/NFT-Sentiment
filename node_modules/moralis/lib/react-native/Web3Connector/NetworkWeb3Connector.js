...
var NetworkWeb3Connector = function (_AbstractWeb3Connecto) {
  ...
  function NetworkWeb3Connector() {
    ...
    _this2.chainId = (0, _verifyChainId.default)(defaultChainId != null ? defaultChainId : Number(Object.keys(urls)[0]));
      ...
      return _regenerator.default.async(function (_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _ref2 = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {}, providedChainId = _ref2.chainId;
